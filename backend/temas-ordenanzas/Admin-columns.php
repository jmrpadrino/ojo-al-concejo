...
--------------------------------------------------------------- */
add_filter( 'manage_posts_columns', 'oda_tema_ord_columns_head' );
add_action( 'manage_posts_custom_column', 'oda_tema_ord_columns_content', 10, 2 );
add_action('admin_head', 'oda_tema_ord_styling_admin_order_list' );

/* --------------------------------------------------------------
    ORDENANZAS: STYLE
--------------------------------------------------------------- */
function oda_tema_ord_styling_admin_order_list() {
?>
<style>
    .label-status {
        display: block;
...
--------------------------------------------------------------- */
function oda_tema_ord_columns_head($defaults){
    if ( $_GET['post_type'] == 'tema_ordenanza' ){
...
--------------------------------------------------------------- */
function oda_tema_ord_columns_content($column_name, $post_ID){
