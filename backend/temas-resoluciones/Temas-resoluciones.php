...
function oda_Tema_resolucion() {

	$labels = array(
		'name'                  => _x( 'Temas', 'Post Type General Name', 'oda' ),
		'singular_name'         => _x( 'Tema', 'Post Type Singular Name', 'oda' ),
		'menu_name'             => __( 'Temas Resoluciones', 'oda' ),
		'name_admin_bar'        => __( 'Tema Resolución', 'oda' ),
    ...
    $args = array(
        ...
        'can_export'            => true,
        'has_archive'           => 'todas-los-temas-de-resoluciones',
        'exclude_from_search'   => false,
        'publicly_queryable'    => true,
        'query_var'             => 'qv_tema_res',
        'rewrite'               => $rewrite,
        'capability_type'       => 'post',
        'show_in_rest'          => true,
        'rest_base'             => 'oda_temas_res',
    );
    register_post_type( 'tema_resolucion', $args );

}
add_action( 'init', 'oda_Tema_resolucion', 0 );

add_action('admin_menu', 'oda_tema_res_menu_item'); 
function oda_tema_res_menu_item() { 
    add_submenu_page(
        'edit.php?post_type=resolucion', 
        'Temas', 
        'Temas', 
        'manage_options', 
        'edit.php?post_type=tema_resolucion'
    ); 
}