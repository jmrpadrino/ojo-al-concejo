...
add_action( 'cmb2_admin_init', 'oda_register_tema_resoluciones_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function oda_register_tema_resoluciones_metabox() {
    $city = null;
	$current_post = null;
	if (isset($_GET['post'])){
