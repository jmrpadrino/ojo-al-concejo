...
--------------------------------------------------------------- */
add_filter( 'manage_posts_columns', 'oda_ordenanza_columns_head' );
add_action( 'manage_posts_custom_column', 'oda_ordenanza_columns_content', 10, 2 );
add_action('admin_head', 'oda_ordenanza_styling_admin_order_list' );

/* --------------------------------------------------------------
    ORDENANZAS: STYLE
--------------------------------------------------------------- */
function oda_ordenanza_styling_admin_order_list() {
?>
<style>
    .label-status {
        display: block;
